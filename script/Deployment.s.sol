...
contract DeploymentScript is BaseDeploymentScript {
    ...
    mapping(uint256 => address) _erc20Token;

    function run() external {
        _erc20Token[ARBITRUM_MAINNET_CHAIN_ID] = ARBITRUM_MAINNET_USDC;
        _erc20Token[ARBITRUM_SEPOLIA_CHAIN_ID] = ARBITRUM_SEPOLIA_USDC;
        _erc20Token[BASE_MAINNET_CHAIN_ID] = BASE_MAINNET_USDC;
        _erc20Token[BASE_SEPOLIA_CHAIN_ID] = BASE_SEPOLIA_USDC;
        _erc20Token[ETHEREUM_MAINNET_CHAIN_ID] = ETHEREUM_MAINNET_USDC;
        _erc20Token[ETHEREUM_SEPOLIA_CHAIN_ID] = ETHEREUM_SEPOLIA_USDC;
        _erc20Token[OP_MAINNET_CHAIN_ID] = OP_MAINNET_USDC;
        _erc20Token[OP_SEPOLIA_CHAIN_ID] = OP_SEPOLIA_USDC;
        ...
        if (block.chainid == ANVIL_CHAIN_ID) {
            ...
            erc20Token = _erc20Token[block.chainid];
        }

...
PUBLIC_CONTRACTS += IERC1155
PUBLIC_CONTRACTS += IERC1155MetadataURI
PUBLIC_CONTRACTS += IERC1155Receiver
PUBLIC_CONTRACTS += IERC165
PUBLIC_CONTRACTS += IERC20
PUBLIC_CONTRACTS += IERC20Metadata
PUBLIC_CONTRACTS += IERC721
PUBLIC_CONTRACTS += IERC721Metadata
PUBLIC_CONTRACTS += IERC721Receiver
...
PUBLIC_CONTRACTS += draft-IERC6093
